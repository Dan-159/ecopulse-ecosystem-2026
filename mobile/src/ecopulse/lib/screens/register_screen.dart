...
import '../services/auth_service.dart'; // Ajusta la ruta a tu auth_service
...
class _RegisterScreenState extends State<RegisterScreen> {
  ...
  void _handleRegister() async {
    ...
    try {
      // Usamos el método register de tu AuthService
      ...
      if (success) {
        ...
        Navigator.pop(context); // Te regresa a la ventana de bienvenida
      } else {
      ...
      if (mounted) {
        setState(() => _isLoading = false); // Apaga el loading pase lo que pase
      }
    }
  }
